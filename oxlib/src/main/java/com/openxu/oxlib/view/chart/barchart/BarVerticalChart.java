package com.openxu.oxlib.view.chart.barchart;
...
import com.openxu.oxlib.view.chart.BaseChart;
import com.openxu.oxlib.view.chart.anim.AngleEvaluator;
import com.openxu.oxlib.view.chart.bean.BarBean;
...
public class BarVerticalChart extends BaseChart {
    ...
    private int textSizeCoordinate = (int)getResources().getDimension(R.dimen.text_size_chart_coordinate); //坐标文字大小
    private int textColorCoordinate = getResources().getColor(R.color.text_color_chart_coordinate);
    private int textSizeTag = (int)getResources().getDimension(R.dimen.text_size_chart_tag); //数值字体
    private int textColorTag = getResources().getColor(R.color.text_color_chart_tag);
    private int textSizeLable = (int)getResources().getDimension(R.dimen.text_size_chart_lable); //lable字体
    private int textColorLable = getResources().getColor(R.color.text_color_chart_tag);
